...
/**
* Upi Stafftype Controller
*
* @package	Upi
* @subpackage	Stafftype
*/
class UpiControllerStafftype extends UpiClassControllerItem
{
	/**
	...
	*/
	public function cancel($key = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			case 'stafftype.cancel':
				$this->applyRedirection($result, array(
					'stay',
					'com_upi.stafftypes.default'
				), array(
					'cid[]' => null
				));
				break;
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'stafftype', 'CMD');
	}
	...
	*/
	public function save($key = null, $urlVar = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			case 'stafftype.apply':
				$this->applyRedirection($result, array(
					'stay',
					'com_upi.stafftype.stafftype'
				), array(
					'cid[]' => $model->getState('stafftype.id')
				));
				break;
