...
/**
* Upi Attendanceexcercies Controller
*
* @package	Upi
* @subpackage	Attendanceexcercies
*/
class UpiControllerAttendanceexcercies extends UpiClassControllerList
{
	/**
	...
	* @var string
	*/
	protected $context = 'attendanceexcercies';
	...
	*/
	public function publish()
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			case 'attendanceexcercy.publish':
				$this->applyRedirection($result, array(
					'stay',
					'com_upi.attendanceexcercies.default'
				), array(
			...
			case 'attendanceexcercy.unpublish':
				$this->applyRedirection($result, array(
					'stay',
					'com_upi.attendanceexcercies.default'
				), array(
