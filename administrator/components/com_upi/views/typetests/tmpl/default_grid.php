...
<div class="">
	<table class='table' id='grid-typetests'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JHTML::_('grid.sort',  "UPI_FIELD_TIME", 'a.time', $listDirn, $listOrder ); ?>
				</th>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td style="text-align:center">
					...
					<?php echo JDom::_('html.fly', array(
						...
						'modalHeight' => 500,
						'modalWidth' => 700,
						'route' => array('view' => 'typetest','layout' => 'typetestmodal','cid[]' => $row->id),
						'target' => 'modal'
					));?>
				</td>
