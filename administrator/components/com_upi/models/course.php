...
* @subpackage	Classes
*/
class UpiModelCourse extends UpiClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'course', 'STRING');
	}
	...
	*/
	public function getTable($type = 'course', $prefix = 'UpiTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_upi.edit.course.data', array());
	...
	* @param	integer	$pk	The primary id key of the course
	*
	* @return	void
	*/
