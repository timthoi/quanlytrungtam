...
/**
* Upi Period Controller
*
* @package	Upi
* @subpackage	Period
*/
class UpiControllerPeriod extends UpiClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'period', 'CMD');
	}
	...
	*/
	public function save($key = null, $urlVar = null)
	{
		...
		switch($this->getLayout() .'.'. $this->getTask())
		{
			...
			case 'period.save2copy':
				$this->applyRedirection($result, array(
					'stay',
					'com_upi.period.period'
				), array(
					'cid[]' => $model->getState('period.id')
				));
				break;
