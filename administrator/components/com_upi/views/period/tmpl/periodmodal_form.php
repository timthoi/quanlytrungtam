...
?>
<h3><?php echo JText::_('UPI_FIELD_PERIOD_ID_TITLE') ?></h3>
...
<tbody>
	...
	<tr>
		<th><?php echo JText::_('UPI_FIELD_WEEK_DAY') ?></th>
		<td><?php echo JDom::_('html.fly.enum', array(
						'dataKey' => 'weekday',
	...
	<tr>
		<th><?php echo JText::_('UPI_FIELD_START_TIME') ?></th>
		<td>
	...
	<tr>
		<th><?php echo JText::_('UPI_FIELD_END_TIME') ?></th>
		<td>
					<?php echo JDom::_('html.fly.datetime', array(
						'dataKey' => 'end_time',
						'dataObject' => $this->item,
