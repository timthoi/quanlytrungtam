...
/**
* Upi Course Controller
*
* @package	Upi
* @subpackage	Course
*/
class UpiControllerCourse extends UpiClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'course', 'CMD');
	}
	...
	*/
	public function save($key = null, $urlVar = null)
	{
	 ...
	 public function ajax_getClassList(){
        $course_id = JRequest::getVar('course_id');
		$result = '';
        if ($course_id) {
			$result = UpiHelper::getDropdownClassList($course_id);
		}
