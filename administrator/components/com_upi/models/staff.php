...
* @subpackage	Classes
*/
class UpiModelStaff extends UpiClassModelItem
{
	/**
	...
	* @var array
	*/
	protected $fileFields = array('profile_pic');
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'staff', 'STRING');
	}
	...
	*/
	public function getTable($type = 'staff', $prefix = 'UpiTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_upi.edit.staff.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('staff.id') == 0)
			{
				...
				$data->relation = null;
				$data->emergency_home_phone = null;
				$data->my_string = null;
				$data->joining_date = null;
				$data->leaving_date = null;
				$data->certification_name = null;
				$data->certification_description = null;
				$data->note = null;
				$data->address_1 = null;
				$data->my_text = null;
	...
	* @param	integer	$pk	The primary id key of the staff
	*
	* @return	void
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		$this->addSelect(	'a.id,'
						...
						.	'a.address_1,'
						.	'a.birthday,'
						.	'a.certification_description,'
						.	'a.certification_name,'
						.	'a.email,'
						.	'a.emergency_home_phone,'
						.	'a.emergency_name,'
						.	'a.ethnicity,'
						.	'a.first_name,'
						.	'a.gender_id,'
						...
						.	'a.creation_date,'
						.	'a.published');
		$this->addSelect('concat(a.first_name,a.last_name) AS `full_name`');
	...
	*/
	public function save($data)
	{
		...
		//Convert from a non-SQL formated date (certification_description)
		$data['certification_description'] = UpiHelperDates::getSqlDate($data['certification_description'], array('Y-m-d'), true, 'USER_UTC');

		//Convert from a non-SQL formated date (note)
		$data['note'] = UpiHelperDates::getSqlDate($data['note'], array('Y-m-d'), true, 'USER_UTC');
