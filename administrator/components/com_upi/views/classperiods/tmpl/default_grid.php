		...
		for ($i=0, $n=count( $this->items ); $i < $n; $i++):
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td style="text-align:left">
					<?php echo UpiHelper::renderJsonPeriod($row->period_id);?>
				</td>

				<td style="text-align:center">
					<span class="label "><?php echo ($row->_subject_id_title)?$row->_subject_id_title:"-";?></span>
				</td>

				<td style="text-align:center">
					<span class="label "><?php echo ($row->_grade_id_title)?$row->_grade_id_title:"-";?></span>
				</td>
