...
* @subpackage	Classes
*/
class UpiModelRoom extends UpiClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'room', 'STRING');
	}
	...
	*/
	public function getTable($type = 'room', $prefix = 'UpiTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_upi.edit.room.data', array());
	...
	* @param	integer	$pk	The primary id key of the room
	*
	* @return	void
	*/
