...
* @subpackage	Classes
*/
class UpiModelSubject extends UpiClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'subject', 'STRING');
	}
	...
	*/
	public function getTable($type = 'subject', $prefix = 'UpiTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_upi.edit.subject.data', array());
	...
	* @param	integer	$pk	The primary id key of the subject
	*
	* @return	void
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		//FROM : Main table
		$query->from('#__upi_subjects AS a');
