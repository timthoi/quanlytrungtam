...
<div class="">
	<table class='table' id='grid-courseperiods'>
		<thead>
			<tr>
				...
				<th style="text-align:center">
					<?php echo JText::_("UPI_FIELD_END_DATE"); ?>
				</th>
				
				<th style="text-align:center">
					<?php echo JText::_("UPI_LAYOUT_COURSE"); ?>
				</th>
				...
				<th style="text-align:center">
					<?php echo JText::_("UPI_FIELD_ACTIVE"); ?>
				</th>
			...
			<tr class="<?php echo "row$k"; ?>">
				...
				<td style="text-align:center">
					<?php echo JDom::_('html.fly', array(
						...
						'modalHeight' => 280,
						'modalWidth' => 500,
						'route' => array('view' => 'courseperiod','layout' => 'courseperiodmodal','cid[]' => $row->id),
						'target' => 'modal'
					));?>
