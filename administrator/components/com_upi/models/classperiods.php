...
* @subpackage	Classes
*/
class UpiModelClassPeriods extends UpiClassModelList
{
	/**
	...
	protected function prepareQuery(&$query)
	{
		...
		switch($this->getState('context', 'all'))
		{
			case 'classperiods.default':
				...
				//SELECT
				$this->addSelect('_class_id_.alias AS `_class_id_alias`');
				...
				$this->addJoin('`#__upi_subjects` AS _subject_id_ ON _subject_id_.id = _class_id_.subject_id', 'LEFT');
				$this->addJoin('`#__upi_grades` AS _grade_id_ ON _grade_id_.id = _class_id_.grade_id', 'LEFT');
