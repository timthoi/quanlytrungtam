...
* @subpackage	Classes
*/
class UpiModelClassroom extends UpiClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getTable($type = 'classroom', $prefix = 'UpiTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_upi.edit.classroom.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('classroom.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the classroom
	*
	* @return	void
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		//FROM : Main table
		$query->from('#__upi_classrooms AS a');
