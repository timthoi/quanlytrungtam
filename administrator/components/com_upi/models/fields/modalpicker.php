...
class JFormFieldModalpicker extends JFormField
{
	...
	*/
	protected function getSelectedLabel()
	{
		...
		$modelItem = JModelLegacy::getInstance($model->getNameItem(), $extension . 'Model');

		$selectedItem = $modelItem->getItem((int)$this->value);

		if ($selectedItem && isset($selectedItem->$labelKey))
