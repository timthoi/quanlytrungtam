...
* @subpackage	Classes
*/
class UpiModelTypetests extends UpiClassModelList
{
	/**
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		//WHERE - SEARCH : search_search : search on Title + Time
