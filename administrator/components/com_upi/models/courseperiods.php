...
* @subpackage	Classes
*/
class UpiModelCourseperiods extends UpiClassModelList
{
	/**
	...
	*/
	public function __construct($config = array())
	{
		...
		$this->hasOne('course_id', // name
			'courses', // foreignModelClass
			'course_id', // localKey
			'id', // foreignKey
			array() // selectFields
		);
	...
	*/
	protected function prepareQuery(&$query)
	{
		...
		if($filter_course_id = $this->getState('filter.course_id'))
		{
		if ($filter_course_id > 0){
				$this->addWhere("a.course_id = " . (int)$filter_course_id);
		}
		}
