...
/**
* Upi Subject Controller
*
* @package	Upi
* @subpackage	Subject
*/
class UpiControllerSubject extends UpiClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'subject', 'CMD');
	}
