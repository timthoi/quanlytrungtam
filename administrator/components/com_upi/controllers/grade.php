...
/**
* Upi Grade Controller
*
* @package	Upi
* @subpackage	Grade
*/
class UpiControllerGrade extends UpiClassControllerItem
{
	/**
	...
	*/
	protected function getLayout($default = null)
	{
		...
		return $jinput->get('layout', 'grade', 'CMD');
	}
