...
* @subpackage	Classes
*/
class UpiModelTest extends UpiClassModelItem
{
	/**
	...
	* @var array
	*/
	protected $fileFields = array('document');
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'test', 'STRING');
	}
	...
	*/
	public function getTable($type = 'test', $prefix = 'UpiTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_upi.edit.test.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('test.id') == 0)
			{
				...
				$data->time = null;
				$data->type_test_id = $jinput->get('filter_type_test_id', $this->getState('filter.type_test_id'), 'INT');
				$data->note = null;
	...
	* @param	integer	$pk	The primary id key of the test
	*
	* @return	void
	*/
