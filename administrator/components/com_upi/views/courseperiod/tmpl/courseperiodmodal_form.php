...
?>
<h3><?php echo JText::_('UPI_LAYOUT_COURSEPERIOD') ?></h3>
<table class="table table-striped">
<tbody>
	<tr>
		<th><?php echo JText::_('UPI_FIELD_COURSE_ID_TITLE') ?></th>
		<td><?php echo $this->item->_course_id_title;?></td>
	</tr>
	<tr>
	...
	<tr>
		<th><?php echo JText::_('UPI_FIELD_START_DATE') ?></th>
	...
	<tr>
		<th><?php echo JText::_('UPI_FIELD_END_DATE') ?></th>
		<td><?php echo JDom::_('html.fly.datetime', array(
				'dataKey' => 'end_date',
				'dataObject' => $this->item,
				'dateFormat' => 'd.m.Y'
