...
<?php $fieldSet = $this->form->getFieldset('test.form');?>
<fieldset class="fieldsform form-horizontal">
	...
	<?php
	// Total Score
	$field = $fieldSet['jform_total_score'];
	?>
	<div class="control-group <?php echo 'field-' . $field->id . $field->responsive; ?>">
		<div class="control-label">
			<?php echo $field->label; ?>
	...
	<?php
	// Detail Score
	$field = $fieldSet['jform_detail_score'];
	?>
	<div class="control-group <?php echo 'field-' . $field->id . $field->responsive; ?>">
		<div class="control-label">
			<?php echo $field->label; ?>
	...
	<?php
	// Type Test ID > Title
	$field = $fieldSet['jform_type_test_id'];
	$field->jdomOptions = array(
		'list' => $this->lists['fk']['type_test_id']
			);
	?>
	<div class="control-group <?php echo 'field-' . $field->id . $field->responsive; ?>">
		<div class="control-label">
