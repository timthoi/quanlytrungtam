...
* @subpackage	Classes
*/
class UpiModelStafftype extends UpiClassModelItem
{
	/**
	* View list alias
	*
	...
	* @var string
	*/
	protected $view_list = 'stafftypes';
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'stafftype', 'STRING');
	}
	...
	*/
	public function getTable($type = 'stafftype', $prefix = 'UpiTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_upi.edit.stafftype.data', array());
		...
		if (empty($data)) {
			...
			if ($this->getState('stafftype.id') == 0)
			{
				$jinput = JFactory::getApplication()->input;
	...
	* @param	integer	$pk	The primary id key of the stafftype
	*
	* @return	void
	*/
	protected function prepareQuery(&$query, $pk)
	{
		...
		//FROM : Main table
		$query->from('#__upi_stafftypes AS a');
