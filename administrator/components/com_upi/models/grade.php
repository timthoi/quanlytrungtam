...
* @subpackage	Classes
*/
class UpiModelGrade extends UpiClassModelItem
{
	/**
	* View list alias
	*
	...
	*/
	public function getLayout()
	{
		...
		return $jinput->get('layout', 'grade', 'STRING');
	}
	...
	*/
	public function getTable($type = 'grade', $prefix = 'UpiTable', $config = array())
	{
	...
	*/
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_upi.edit.grade.data', array());
	...
	* @param	integer	$pk	The primary id key of the grade
	*
	* @return	void
	*/
